...
export const ROSTER = [
  ...
  student('marcus', 'Marcus Chen', 'MC', '#0CA7BC', 27, 7, 94, 'defiance', 'telegraph-club', 62),
  student('tyler', 'Tyler Voss', 'TV', '#0BA85F', 27, 4, 78, 'momentum', 'crossover', 49),
  ...
  student('omar', 'Omar Aziz', 'OA', '#FFBC42', 11, 0, 68, 'provisions', 'hatchet', 22),

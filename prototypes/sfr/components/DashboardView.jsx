...
const NAV = [{ id: 'dashboard', label: 'Dashboard', icon: 'overview' }]
        ...
        <div className="dash-sfr-cta" onClick={onGoToSfr}>
          <div className="dash-sfr-cta-body">
            ...
            <div className="dash-sfr-cta-desc">
              {flaggedCount} flagged {flaggedCount === 1 ? 'session' : 'sessions'} from the past 7
              days are waiting for your attention. Review Book Talk conversations and take action on

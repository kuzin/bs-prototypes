...
function ReqCards({ options, value, onChange }) {
  return (
    <div className="gb-optcards gb-optcards--stack" role="radiogroup">
      {options.map((o) => {
        ...
        return (
          <button
            ...
            role="radio"
            aria-checked={on}
            className={`gb-optcard${on ? ' is-on' : ''}`}
            onClick={() => onChange(o.value)}
          >
            <span className="gb-optcard-ic" aria-hidden="true">
              <Icon name={o.icon} size={18} />
            </span>
            <span className="gb-optcard-text">
              <strong>{o.title}</strong>
              <span>{o.desc}</span>
            </span>
            <span className="gb-optcard-dot" aria-hidden="true" />
          </button>
        )
      })}
    </div>
    ...
    <section className="gb-step">
      ...
      {isRLC && (
        <div className="gb-panel">
          <h3 className="gb-panel-title">Completion type</h3>
          <div className="gb-settings">
            <div className="gb-setting-row is-disabled">
              <div className="gb-setting-text">
                <span className="gb-setting-label">Badges</span>
            ...
            <div className="gb-setting-row">
              <div className="gb-setting-text">
                <span className="gb-setting-label">Completing titles</span>
                <span className="gb-setting-sub">
      ...
      {isRLC && titlesEnabled && (
        <div className="gb-panel">
          <h3 className="gb-panel-title">Title requirements</h3>
          <ReqCards
          ...
          />
          {c.titleMode === 'some' && (
            <Field label="Titles required" className="gb-w-sm">
              <NumberInput
      ...
      <div className="gb-panel">
        <h3 className="gb-panel-title">Badge requirements</h3>
        <ReqCards
        ...
        />
        {c.mode === 'some' && (
          <Field label="Badges required" className="gb-w-sm">
            <NumberInput
              value={c.count ?? 1}
              min={1}
        ...
        {(c.mode === 'specific' || c.mode === 'some') &&
          (badgePool.length > 0 ? (
            ...
            <Banner level="warning" className="gb-panel-banner">

...
import './JoyfulFooter.css'

// The Joyful footer — the current unified footer across Beanstack, Comics Plus,
// MyDot and RMI. It lives in its own module (rather than inside the footers
// prototype's App) so another prototype can render the real thing without also
// pulling that prototype's page reset and body styles.
//
...
export const APPS = [
  ...
  },
  {
    ...
    name: 'RMI Classroom',
    accent: '#0CA7BC',
    logo: <BeanstackLogo size="sm" word="RMI" upper className="ft-logo" />,
    hasLanguage: true,
    hasAppStores: false,

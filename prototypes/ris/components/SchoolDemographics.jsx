    ...
    <div className="dm-root">
      ...
      <div className="rc-stats-row">
        ...
        <StatCard
          ...
          label="FRL rate"
          footer={
            details.frl >= 50 ? 'High-need school' : details.frl >= 30 ? 'Mixed-income' : 'Low FRL'
          }
          color={DEMO_COLOR}
        />
        <StatCard
          ...
          <Table
            ...
            columns={[
              ...
              },
              {
                ...
                render: (_, r) => (
                  <ProgressBar value={r.rmi} max={100} color={rmiColor(r.rmi)} size="sm" />
                ),
              },
        ...
        >
          <div className="dm-actions">
            {details.frl >= 50 && (
              <div className="dm-action-row dm-action-row--critical">
                ...
                <div className="dm-action-text">
                  With {Math.round((school.students * details.frl) / 100).toLocaleString()} students
                  on free/reduced lunch, monitor engagement gaps in lower-grade cohorts and consider
                  expanded book access programs.
                </div>
              </div>
            )}
            {stats.rmi < 75 && (
              <div className="dm-action-row dm-action-row--warning">
                ...
                <div className="dm-action-text">
                  School-level RMI sits at {stats.rmi}. Look at the lowest-performing grade in the
                  chart above and target a re-engagement challenge or teacher-led check-in.
                </div>
              </div>
            )}
            <div className="dm-action-row">
              ...
              <div className="dm-action-text">
                Compare engagement rates between FRL-eligible students and the overall student body.
                If the gap exceeds 10pp, consider a targeted reading challenge or book-access
                intervention.
              </div>
            </div>
          </div>

...
const READERS = [
  {
    ...
    last: 'Leidy',
    age: 8.0,
    program: 'Read It Your Way',
    startedOn: '2026-05-25 22:04:17 -0400',
  },
  {
    first: 'Joshua',
    last: 'Barnell',
    age: 10.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-26 00:36:49 -0400',
  },
  {
    first: 'Elijah',
    last: 'Barnell',
    age: 8.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-26 00:37:50 -0400',
  },
  {
    first: 'Ashley',
    last: 'Barnell',
    age: '19+',
    program: 'Adult Summer 2026',
    startedOn: '2026-05-26 00:38:17 -0400',
  },
  {
    first: 'Maya',
    last: 'Patel',
    age: 9.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-22 18:11:02 -0400',
  },
  {
    first: 'Liam',
    last: 'Chen',
    age: 10.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-22 09:45:31 -0400',
  },
  {
    first: 'Ava',
    last: 'Nguyen',
    age: 7.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-21 14:23:19 -0400',
  },
  {
    first: 'Noah',
    last: 'Garcia',
    age: 11.0,
    program: 'Lincoln Reading Club',
    startedOn: '2026-05-21 11:08:53 -0400',
  },
  {
    first: 'Olivia',
    last: 'Robinson',
    age: 12.0,
    program: 'Lincoln Reading Club',
    startedOn: '2026-05-20 19:33:00 -0400',
  },
  {
    first: 'Ethan',
    last: 'Walker',
    age: 8.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-20 16:47:18 -0400',
  },
  {
    first: 'Sofia',
    last: 'Martinez',
    age: 9.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-20 10:02:44 -0400',
  },
  {
    first: 'Jackson',
    last: 'Cooper',
    age: 7.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-19 21:14:01 -0400',
  },
  {
    first: 'Isabella',
    last: 'Hughes',
    age: 10.0,
    program: 'Lincoln Reading Club',
    startedOn: '2026-05-19 17:36:25 -0400',
  },
  {
    first: 'Aiden',
    last: 'Ramirez',
    age: 11.0,
    program: 'Lincoln Reading Club',
    startedOn: '2026-05-19 09:55:12 -0400',
  },
  {
    first: 'Mia',
    last: 'Brooks',
    age: 9.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-18 20:41:09 -0400',
  },
  {
    first: 'Lucas',
    last: 'Foster',
    age: 12.0,
    program: 'Lincoln Reading Club',
    startedOn: '2026-05-18 13:27:50 -0400',
  },
  {
    first: 'Amelia',
    last: 'Bennett',
    age: 8.0,
    program: 'Kids Summer 2026',
    startedOn: '2026-05-18 08:19:33 -0400',
  },
  {
    first: 'Henry',
    last: 'Russell',
    age: 10.0,
    program: 'Lincoln Reading Club',
    startedOn: '2026-05-17 22:54:08 -0400',
  },
]
...
export const METRIC_DETAILS = {
  'active-readers': {
    ...
    caption:
      'Readers who have logged a reading session in the selected period. A reader logging in 2 of the selected challenges is counted once.',
    columns: [
  ...
  'new-registrations': {
    ...
    caption:
      'Total of readers who have registered for a challenge. A reader who has registered for 2 of the selected challenges will be included as 2 readers in this calculation.',
    columns: [
      { key: 'first', label: 'First Name' },
      { key: 'last', label: 'Last Name' },
      { key: 'age', label: 'Age' },
  ...
  'completed-activities': {
    ...
    caption:
      'Activities marked complete by a reader (could be a custom activity, badge requirement, or reward).',
    columns: [
      { key: 'first', label: 'First Name' },
      { key: 'last', label: 'Last Name' },

...
export const TOP_BOOKS = [
  ...
  {
    id: 5,
    name: 'Wings of Fire: The Dragonet Prophecy',
    count: 64,
    isbn: '0545349184',
    color: '#B91C1C',
  },
...
export const ACTIONS = [
  {
    id: 'a-flags',
    title: 'Review flagged sessions',
    subtitle: "3 sessions need a teacher's eyes",
    icon: 'flag',
    attention: 3,
    cta: 'Review',
    roles: ['teacher', 'media'],
  },
  {
    ...
    subtitle: '12 students newly earned a reward',
    icon: 'reward',
    attention: 12,
    cta: 'Distribute',
    roles: ['media'],
  ...
  },
  {
    id: 'a-bnc',
    title: 'Run BNC',
    subtitle: 'Weekly nudge to capture rewards data',
    icon: 'chart',
    cta: 'Open BNC',
    roles: ['media'],
  },
  {
    id: 'a-lexile',
    title: 'Explore Lexile Insights',
    subtitle: 'See where readers are growing',
    icon: 'lexile',
    cta: 'Open',
    roles: ['teacher', 'media'],
  },
...
// layout yet.
export const DEFAULT_LAYOUT_BY_ROLE = {
  teacher: DEFAULT_LAYOUT,
  media: MEDIA_DEFAULT_LAYOUT,
  library: LIBRARY_DEFAULT_LAYOUT,
}
...
export const DEFAULT_PRESET_BY_ROLE = {
  teacher: DEFAULT_PRESET_ID,
  media: MEDIA_DEFAULT_PRESET_ID,
  library: LIBRARY_DEFAULT_PRESET_ID,
}

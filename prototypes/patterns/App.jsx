...
import { SECTIONS, HealthStat, ReadingHealth } from '@components/ReadingHealth/ReadingHealth'
import { AlertRow, AlertsBanner } from '@components/AlertsBanner/AlertsBanner'
import { Hero } from '@components/Hero/Hero'
import { PrototypeNav } from '@components/PrototypeNav/PrototypeNav'
import { Sidebar, SchoolPicker } from '@components/Sidebar/Sidebar'
...
import { RMI_FACTORS, SCHOOLS } from '../ris/data'
...
function GroupHeader({ icon, title, desc, color }) {
  return (
    <div className="pt-group-header">
      <div
        className="pt-group-header-icon"
        style={
          color
            ? {
        ...
        <main className="pt-content">
          ...
          <div className="pt-group">
                ...
                <Variant label="tone='neutral'" bare>
                  <ChartCard title="Neutral" accent="#1D4ED8" bodyPad="padded">
                    <CardNote tone="neutral">
                      Sample neutral note text — used for grayscale callouts that don't need the
                      card's accent color.
                    </CardNote>
                  </ChartCard>
                </Variant>
                <Variant label="tone='accent'" bare>
                  <ChartCard title="Accent" accent="#E8866A" bodyPad="padded">
                    <CardNote tone="accent">
                      Intrinsic subscore rose from <strong>12.1</strong> to{' '}
                      <strong>14.2 /20</strong>, outpacing extrinsic motivation.
                    </CardNote>
                  </ChartCard>
                </Variant>
              </div>
            ...
            <Section
              ...
              desc={
                <>
                  Stage-card funnel for conversion / habit-depth flows. Each step is a card with the
                  count, % of total, optional <code>↑Δpp</code>, stage label, and note. A drop-off
                  annotation is computed and rendered between consecutive cards. Stacks vertically —
          ...
          <div className="pt-group">
            ...
            >
              <Variant label="default">
                <BennyBubble>
                  Students started <strong>16</strong> Book Talks with Benny and completed{' '}
                  <strong>14</strong> so far this week. Most students are positively engaged in the
                  books they finished, while Beanstack detected <strong>11</strong> logs over your
                  site's 50-minute warning.
                </BennyBubble>
              </Variant>
              <Variant label="with timestamp">
                <BennyBubble timestamp="May 15 at 9:55am">
                  Marcus is an outstanding reader. He's logged reading on{' '}
                  <strong>21 of the last 30 days</strong> — the highest consistency in the class —
                  and is reading well above grade level at 870L.
                </BennyBubble>
              </Variant>
            </Section>
                  ...
                  sessions={[
                    {
                      ...
                      flags: [
                        ...
                        },
                        {
                          ...
                          type: 'no-recall',
                          label: 'No Book Recall',
                          description: 'Could not name any characters beyond the protagonist.',
                        },
                      ],
                      conversation: [],
                    },
                      ...
                      flags: [
                        {
                          ...
                          description: 'Answer did not relate to the question.',
                        },
                      ],
                      conversation: [],
                    },

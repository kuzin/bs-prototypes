    ...
    <div className="rc-page" style={{ '--rc-accent': ACCENT }}>
      ...
      <div className="sv-grid">
        ...
        >
          <TrendChart
            ...
            series={[
              ...
              ...SCHOOLS.map(s => ({ key: s.id, name: s.name.split(' ')[0], color: s.color, strokeWidth: 1.5 })),
            ]}
          />
        </ChartCard>
        ...
        <ChartCard
          ...
          span={2}
          footer={
            <ChartLegend items={SCHOOLS.map(s => ({ color: s.color, label: s.name.split(' ')[0] }))} />
          }
        >
          <TrendChart
            type="bar"
        ...
        >
          <TrendChart
            ...
            series={VELOCITY_LEVELS.map(l => ({ key: l.key, name: l.label, color: l.color, strokeWidth: 2 }))}
          />
        </ChartCard>

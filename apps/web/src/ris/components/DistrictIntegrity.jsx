...
export function DistrictIntegrity() {
  ...
  const completionRanked = [...BOOK_TALKS_BY_SCHOOL].sort((a, b) => b.completionRate - a.completionRate)
        ...
        >
          <TrendChart
            ...
            series={[
              ...
              { key: 'flagRate',       name: 'Flag Rate',       color: FLAG_COLOR, fillOpacity: 0.12, dashed: true },
            ]}
          />

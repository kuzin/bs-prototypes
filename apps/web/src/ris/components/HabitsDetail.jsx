        ...
        <div className="hd-card hd-card--wide">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={SESSION_TRENDS} margin={{ top: 4, right: 16, left: -20, bottom: 0 }}>
              ...
              <YAxis domain={[8, 30]} tick={{ fontSize: 13, fill: '#94A3B8' }} unit=" min" />
        ...
        <div className="hd-card">
          ...
          <ResponsiveContainer width="100%" height={220}>
            ...
            >
              ...
              <XAxis type="number" domain={[0, 30]} tick={{ fontSize: 13, fill: '#94A3B8' }} unit=" min" />
        ...
        <div className="hd-card">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={VELOCITY_TRENDS} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
              ...
              <Tooltip formatter={v => `${v} bks/mo`} contentStyle={{ fontSize: 13, borderRadius: 8, border: '1px solid #E2E8F0' }} />
              <Legend wrapperStyle={{ fontSize: 13 }} />

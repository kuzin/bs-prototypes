  ...
  return (
    <nav className="proto-nav">
      ...
      <div className="proto-nav-switcher">
        {prev ? (
          <a href={prev.href} className="proto-nav-arrow" title={`Previous: ${prev.name}`} aria-label={`Previous: ${prev.name}`}>
        ...
        <div className="proto-nav-select-wrap">
          ...
          >
            ...
            <span className="proto-nav-select-name">{current ? current.name : 'Select prototype'}</span>
            <svg className="proto-nav-select-caret" viewBox="0 0 16 16" width="11" height="11" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {next ? (
          <a href={next.href} className="proto-nav-arrow" title={`Next: ${next.name}`} aria-label={`Next: ${next.name}`}>
            <svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

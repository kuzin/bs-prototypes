...
import '../ris/components/ProgressBar.css'
    ...
    <header className="wa-topbar">
      <div className="wa-topbar-inner">
        ...
        <div className="wa-topbar-actions">
          <Button variant="primary" size="sm" icon={<IconBook />}>Log Reading</Button>
          <Button variant="ghost" size="sm" icon={<IconCheck />}>Complete Activity</Button>
          <Button variant="ghost" size="sm" icon={<IconPencil />}>Write Review</Button>
        </div>
        <div className="wa-topbar-user">
          ...
          <button className="wa-icon-btn" aria-label="Settings"><IconGear /></button>
        </div>
      </div>
...
function StreakBanner({ onDismiss }) {
  return (
    <div className="wa-streak">
      ...
      <Button variant="secondary" size="sm">View Streaks</Button>
  ...
  return (
    <button className="wa-chcard" type="button">
      <div className="wa-chcard-hero" style={{ background: art.bg }}>
        <span className="wa-chcard-emoji" aria-hidden>{art.emoji}</span>
        <span className="wa-chcard-arttitle" style={{ color: art.titleColor }}>{art.title}</span>
        <span className="wa-chcard-pill">
          <Pill color="#0DA7BC" variant="filled" size="sm">{challenge.badge}</Pill>
        </span>
      </div>
  ...
  return (
    <button className="wa-chcard wa-chcard--add" type="button">
      <div className="wa-chcard-add-inner">
        <span className="wa-chcard-add-plus" aria-hidden>+</span>
...
function LeaderboardCard() {
  ...
  return (
    <aside className="wa-card wa-leadcard">
      ...
      <ul className="wa-leadcard-list">
        {rows.map(row => (
          <li key={row.rank} className="wa-leadcard-row">
            <span className="wa-leadcard-rank" style={{ background: row.color }}>{row.rank}</span>
      ...
      <a href="#" className="wa-leadcard-more">View All Schools</a>
    </aside>
  )
}
      ...
      <footer className="wa-footer">
        <div className="wa-footer-inner">
          ...
          <div className="wa-footer-copy">
            © 2024 Zoobean, Inc. <span>•</span> <a href="#">Terms</a> <span>•</span> <a href="#">Privacy</a>
          </div>
        </div>
      </footer>
    </>
          ...
          <div className="wa-layout">
            <section className="wa-content">
              ...
              <div className="wa-group">
                ...
                <div className="wa-group-sub">Challenges that {USER.firstName} is participating in.</div>

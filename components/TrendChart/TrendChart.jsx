  ...
  return (
    <ResponsiveContainer width="100%" height={h}>
      ...
      >
        ...
        <CartesianGrid {...RCHART_GRID} horizontal={!isHorizontal} vertical={isHorizontal} />
        {isHorizontal ? (
          <>
          ...
          if (type === 'bar') {
            ...
            return (
              ...
              >
                ...
                {s.colorFn && data.map((row, j) => <Cell key={j} fill={s.colorFn(row)} />)}
              </Bar>
            )
          }
          return (

  ...
  return (
    <div className={`main-rail ${className}`.trim()}>
      ...
      {Array.from({ length: 8 }).map((_, i) => (
        <div
          key={i}
          className={`main-rail-btn${i === activeIndex ? ' main-rail-btn--active' : ''}`}
        >
          <div className="main-rail-icon" />
        </div>
      ))}
      <div className="main-rail-spacer" />
      <div className="main-rail-btn">
        <div className="main-rail-icon main-rail-icon--round" />
      </div>
      <div className="main-rail-btn">
        <div className="main-rail-icon main-rail-icon--round main-rail-icon--help">?</div>
      </div>
